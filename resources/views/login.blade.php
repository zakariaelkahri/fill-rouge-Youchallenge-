    ...
    <nav class="bg-green-700 text-white shadow-lg">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:ml-6 md:flex md:space-x-8">
                        <a href="#" class="border-b-2 border-transparent hover:border-white text-white px-3 py-2 text-sm font-medium">Home</a>
                ...
                <div class="hidden md:flex items-center">
                    <a href="{{ route('showregisterform') }}" class="text-white hover:bg-green-600 px-3 py-2 rounded-md text-sm font-medium">Register</a>
                    <a href="{{ route('login') }}" class="ml-4 bg-white text-green-700 hover:bg-green-100 px-4 py-2 rounded-md text-sm font-medium">Login</a>
                </div>
                <!-- Mobile menu button -->
        ...
        <div class="hidden mobile-menu md:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <a href="{{ route('accueil') }}" class="text-white block px-3 py-2 rounded-md text-base font-medium hover:bg-green-600">Home</a>
                ...
                <a href="{{ route('login') }}" class="text-white block px-3 py-2 rounded-md text-base font-medium hover:bg-green-600">Login</a>
            </div>
        </div>
    </nav>
        ...
        <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-md border-2 border-green-600">
            <div class="flex justify-center mb-6">
                <div class="rounded-full bg-green-100 p-3">
                    <i class="fas fa-user-lock text-3xl text-green-700"></i>
                </div>
            </div>
            <h2 class="text-3xl font-bold mb-6 text-center text-green-700">Welcome Back</h2>
